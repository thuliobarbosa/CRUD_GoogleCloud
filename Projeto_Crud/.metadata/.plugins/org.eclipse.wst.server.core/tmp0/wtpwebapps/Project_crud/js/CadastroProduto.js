class CadastroProduto {
    ...
    mostraFormularioEdit() {
        document.querySelector("#cadastro-produto-titulo").innerHTML = "Alterar Produto";
        let modal = document.querySelector("#ModalFormProduto");
		modal.style.display = "block";
    }	
...
function editaCadastro(idProduto) {
	...
	let id = formCadastro.querySelector("#idCad");
	id.value = idProduto;
